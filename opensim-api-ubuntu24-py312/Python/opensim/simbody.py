...
class StdVectorStdVectorInt(object):
    ...
    def iterator(self):
        return _simbody.StdVectorStdVectorInt_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _simbody.StdVectorStdVectorInt___nonzero__(self)

    def __bool__(self):
        return _simbody.StdVectorStdVectorInt___bool__(self)

    def __len__(self):
        return _simbody.StdVectorStdVectorInt___len__(self)

    def __getslice__(self, i, j):
        return _simbody.StdVectorStdVectorInt___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _simbody.StdVectorStdVectorInt___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _simbody.StdVectorStdVectorInt___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _simbody.StdVectorStdVectorInt___delitem__(self, *args)

    def __getitem__(self, *args):
        return _simbody.StdVectorStdVectorInt___getitem__(self, *args)

    def __setitem__(self, *args):
        return _simbody.StdVectorStdVectorInt___setitem__(self, *args)

    def pop(self):
        return _simbody.StdVectorStdVectorInt_pop(self)

    def append(self, x):
        return _simbody.StdVectorStdVectorInt_append(self, x)

    def empty(self):
        return _simbody.StdVectorStdVectorInt_empty(self)

    def size(self):
        return _simbody.StdVectorStdVectorInt_size(self)

    def swap(self, v):
        return _simbody.StdVectorStdVectorInt_swap(self, v)

    def begin(self):
        return _simbody.StdVectorStdVectorInt_begin(self)

    def end(self):
        return _simbody.StdVectorStdVectorInt_end(self)

    def rbegin(self):
        return _simbody.StdVectorStdVectorInt_rbegin(self)

    def rend(self):
        return _simbody.StdVectorStdVectorInt_rend(self)

    def clear(self):
        return _simbody.StdVectorStdVectorInt_clear(self)

    def get_allocator(self):
        return _simbody.StdVectorStdVectorInt_get_allocator(self)

    def pop_back(self):
        return _simbody.StdVectorStdVectorInt_pop_back(self)

    def erase(self, *args):
        return _simbody.StdVectorStdVectorInt_erase(self, *args)

    def __init__(self, *args):
        _simbody.StdVectorStdVectorInt_swiginit(self, _simbody.new_StdVectorStdVectorInt(*args))

    def push_back(self, x):
        return _simbody.StdVectorStdVectorInt_push_back(self, x)

    def front(self):
        return _simbody.StdVectorStdVectorInt_front(self)

    def back(self):
        return _simbody.StdVectorStdVectorInt_back(self)

    def assign(self, n, x):
        return _simbody.StdVectorStdVectorInt_assign(self, n, x)

    def resize(self, *args):
        return _simbody.StdVectorStdVectorInt_resize(self, *args)

    def insert(self, *args):
        return _simbody.StdVectorStdVectorInt_insert(self, *args)

    def reserve(self, n):
        return _simbody.StdVectorStdVectorInt_reserve(self, n)

    def capacity(self):
        return _simbody.StdVectorStdVectorInt_capacity(self)
    __swig_destroy__ = _simbody.delete_StdVectorStdVectorInt

# Register StdVectorStdVectorInt in _simbody:
_simbody.StdVectorStdVectorInt_swigregister(StdVectorStdVectorInt)
...
class PolygonalMesh(object):
    ...
    def hasNormals(self):
        r""" Check whether the PolygonalMesh contains Normals information."""
        return _simbody.PolygonalMesh_hasNormals(self)

    def hasNormalsAtVertices(self):
        r""" Check whether the PolygonalMesh contains Normals information at ALL vertices."""
        return _simbody.PolygonalMesh_hasNormalsAtVertices(self)

    def hasNormalsAtFaces(self):
        r""" Check whether the PolygonalMesh contains Normals information.at ALL faces"""
        return _simbody.PolygonalMesh_hasNormalsAtFaces(self)

    def hasTextureCoordinates(self):
        r""" Check whether the PolygonalMesh contains Texture information.at ALL faces or vertices"""
    ...
    def getVertexNormal(self, *args):
        ...
        *Overload 1:*
        Get the normal of a vertex in the mesh, vertex specified by face/vertex.
           :type faceIndex: int, in
           :param faceIndex:  The index of the face (as returned by addFace()).
           :type vertexIndex: int, in
           :param vertexIndex:  The index of the vertex within the face.
           :rtype: :py:class:`UnitVec3`
    ...
    def addNormal(self, normal):
        ...
        Add vertex normal to the mesh.
           :type normal: :py:class:`UnitVec3`, in
           :param normal:   The unit vector of the normal to add, measured and
                                   expressed in the mesh local frame.
    ...
    def addTextureCoordinate(self, textureCoord):
        ...
        Add texture coordinate to the mesh.
           :type textureCoord: :py:class:`Vec2`, in
           :param textureCoord:   The u-v vector of texture coordinates to be associated.
    ...
    def loadObjFile(self, *args):
        ...
        *Overload 2:*
        Alternate signature for Wavefront OBJ format that takes an already-open
           ...
           :type file: std::istream, in/out
           :param file:    An input stream from which to load the file
                                       contents. *
        """
